...
def main(args):
    ...
    traindata = npy.getdata(args.dir, args.mode, args.tb,args.te,args.leib,args.leie, transform=traintransforms)
    valdata = npy.getdata(args.dir, args.mode+1, args.tb,args.te,args.leib,args.leie, transform=valtransforms)
    testdata = npy.getdata(args.dir, args.mode + 2, args.tb, args.te, args.leib, args.leie, transform=valtransforms)
    ...
    testdataloader = torch.utils.data.DataLoader(testdata, batch_size=args.batch_size, shuffle=True, num_workers=0)
    ...
    print("平均准确率",sum_acc/num_epochs)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--s_size', type=int, default=5,help='多少步更新')
   ...
   # parser.add_argument('--dced', type=list, default=['AATH','DP','BRIX','ETOFTS','TOFTS'])
    parser.add_argument('--batch_size', type=int, default=128, help='批次的大小')
    ...
    parser.add_argument('--prodir', type=str,
                        default="", help='数据集的地址')
    parser.add_argument('--weights', type=str, default='./output/vggface30_1_2_pro6_res18_109.pkl',
                        help='模型的初始参数')
    parser.add_argument('--freeze-layers', type=bool, default=True, help='是否要冻结某些层')
