    ...
    for epoch in range(args.num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if (phase == 'val'):
                val_loss = epoch_loss
                val_acc=epoch_acc
            print('nums:{} {} Loss: {:.4f} Acc: {:.4f}'.format(nums,phase, epoch_loss, epoch_acc),end='   ')
            # deep copy the model
...
if __name__ == "__main__":
    for nums in [2,50,100,200,400, 800,1200,2000]:
       ...
       # parser.add_argument('--dced', type=list, default=['AATH','DP','BRIX','ETOFTS','TOFTS'])
        ...
        parser.add_argument('--msave', type=str,
                            default="animal_1_"+str(nums)+"_pro1_res18_", help='模型保存名称')
        parser.add_argument('--prodir', type=str,
                            default="input/animal_pro2001_1.npy", help='扩增的地址')
