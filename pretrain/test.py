...
if __name__ == "__main__":
   ...
   # parser.add_argument('--dced', type=list, default=['AATH','DP','BRIX','ETOFTS','TOFTS'])
    parser.add_argument('--batch_size', type=int, default=32, help='批次的大小')
    parser.add_argument('--p', type=float, default=0.01, help='类别的比例')
    parser.add_argument('--lr', type=float, default=0.0001)
    parser.add_argument('--lrf', type=float, default=0.1)
    parser.add_argument('--dex', type=int, default=0)
    parser.add_argument('--tb', type=int, default=30,help='ani=30,fllow=12') #验证集开始
    parser.add_argument('--te', type=int, default=65,help='ani=65,fllow=26')  # 验证集结束，测试集开始
    parser.add_argument('--leib', type=int, default=119,help='ani=119,fllow=85')  # 类别开始
    parser.add_argument('--leie', type=int, default=150,help='ani=150,fllow=103')  # 类别结束
    parser.add_argument('--dir', type=str,
                        default="input/animal_128.npy",help='数据集的地址')
    parser.add_argument('--prodir', type=str,
                        default="", help='数据集的地址')
    parser.add_argument('--weights', type=str, default='./output/animal_1_800_pro1_res18_80.pkl',
                        help='模型的初始参数')
