...
parser.add_argument('--input_image_dir', type=str, default='./results/dce_lofgan/test_for_fid')
...
def inception_score(batch_size=args.batch_size, resize=True, splits=10,k=0):
    # Set up dtype
...
def readDir(k):
    dirPath = args.input_image_dir+str(k)
    allFiles = []
...
if __name__ == '__main__':
    i=[]
    for k in range(11):
        MAX, IS = inception_score(splits=10,k=k)
        i.append(IS)
