...
# 保持loggan中间结构变成resnet不变，将3个log组合在一起
class DaGAN4(nn.Module):
    def __init__(self, config):
        super(DaGAN4, self).__init__()
...
class Gen(nn.Module):
    ...
    def forward(self, xs):
        ...
        fake_x = self.decoder(feat_gens, similarity,b,k)
...
class unet_decoder(nn.Module):
    def __init__(self,ch):
        ...
        decode2 = [ Conv2dBlock(ch * 2, ch * 2, 3, 1, 1,
                             norm='bn',
                             activation='lrelu',
                             pad_type='reflect')]
        ...
        decode3 =[ Conv2dBlock(ch * 2, ch * 2, 3, 1, 1,
                             norm='bn',
                             activation='lrelu',
                             pad_type='reflect')]
    ...
    def forward(self,x,similarity,b,k):
