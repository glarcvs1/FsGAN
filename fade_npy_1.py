...
parser.add_argument('--name', type=str,default='save_reslut/reslut_net6/vggface_lofgan')
...
if __name__ == '__main__':
    ...
    for cls in tqdm(range(data_for_gen.shape[0]), desc='generating fake images'):
        ...
        print(out.shape)
    np.save('classification/input/'+args.dataset+'_pro2000_6.npy', out) #_1为lof _6为net6